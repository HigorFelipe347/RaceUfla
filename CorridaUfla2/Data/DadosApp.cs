...
namespace CorridaUfla2.Data
{
    ...
    {
        // Correção: Agora são Propriedades { get; set; } e usam new() simplificado
        ...
        public static int NextIdUsuario() => (Corredores.Count + Organizadores.Count) + 1;
        public static int NextIdKit() => Kits.Count + 1;
        public static int NextIdCorrida() => Corridas.Count + 1;
        public static int NextIdInscricao() => Inscricoes.Count + 1;
    }
}